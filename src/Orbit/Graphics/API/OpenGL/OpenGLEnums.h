...
enum class OpenGLBufferUsage : GLenum
{
	StreamDraw  = 0x88e0,
	StreamRead  = 0x88e1,
	StreamCopy  = 0x88e2,
...
enum class OpenGLIndexType : GLenum
{
	Byte  = 0x1401,
	Short = 0x1403,
	Int   = 0x1405,
...
enum class OpenGLBufferParam : GLenum
{
	Access = 0x88bb,
	Mapped = 0x88bc,
	Size   = 0x8764,
...
enum class OpenGLBufferPointerParam : GLenum
{
	MapPointer = 0x88Bd,
};

enum class OpenGLVertexAttribArrayParam : GLenum
{
...
enum class OpenGLVertexAttribArrayPointerParam : GLenum
{
	Pointer = 0x8645,
};

enum class OpenGLVertexAttribDataType : GLenum
{
	Byte          = 0x1400,
	UnsignedByte  = 0x1401,
	Short         = 0x1402,
...
enum class OpenGLAttribDataType : GLenum
{
	Float           = 0x1406,
	FloatVec2       = 0x8B50,
	FloatVec3       = 0x8B51,
...
enum class OpenGLUniformDataType : GLenum
{
	Float                                = 0x1406,
	FloatVec2                            = 0x8B50,
	FloatVec3                            = 0x8B51,
...
enum class OpenGLProgramParam : GLenum
{
	DeleteStatus                      = 0x8B80,
	LinkStatus                        = 0x8B82,
...
enum class OpenGLShaderParam : GLenum
{
	ShaderType         = 0x8B4F,
	DeleteStatus       = 0x8B80,
...
enum class OpenGLMapAccess : GLbitfield
{
	ReadBit             = 0x0001,
	WriteBit            = 0x0002,
...
enum class OpenGLTextureUnit : GLenum
{
	Texture0  = 0x84C0,
	Texture1  = 0x84C1,
	Texture2  = 0x84C2,
...
enum class OpenGLBlendFactor : GLenum
{
	Zero                  = 0,
	One                   = 1,
	SrcColor              = 0x0300,
...
enum class OpenGLBlendMode : GLenum
{
	Add             = 0x8006,
	Min             = 0x8007,
	Max             = 0x8008,
