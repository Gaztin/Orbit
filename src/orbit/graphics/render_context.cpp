...
#include "orbit/graphics/platform/d3d11/context_d3d11.h"
#include "orbit/graphics/platform/opengl/context_gl.h"
	...
	: m_api(api)
{
	switch (m_api)
	{
		...
		case graphics_api::D3D11:
			m_context = std::make_unique<platform::context_d3d11>(parentWindow.get_handle());
			break;
#endif
#if defined(ORB_HAS_OPENGL)
		case graphics_api::OpenGL:
			m_context = std::make_unique<platform::context_gl>(parentWindow.get_handle());
			break;
#endif
		default:
			throw;
